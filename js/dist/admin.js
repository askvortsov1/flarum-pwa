...
var PWAPage = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    ...
    return m("div", {
      ...
      type: 'bool'
    }))), m("fieldset", null, m("fieldset", null, m("legend", null, app.translator.trans('askvortsov-pwa.admin.pwa.firebase.heading')), this.buildSettingComponent({
      ...
      type: 'file'
    }))), m("div", null, "If has firebase auth, show a note that the auth is registered."), this.submitButton(), m("fieldset", null, m("legend", null, app.translator.trans('askvortsov-pwa.admin.pwa.logo_heading')), m("div", {
      className: "helpText"
